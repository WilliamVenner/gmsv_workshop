...
extern "C" {
	#[link_name = "\u{1}_ZN23SteamNetworkingIdentity15SetGenericBytesEPKvj"]
...
extern "C" {
	...
	#[link_name = "\u{1}_ZNK23SteamNetworkingIdentity8ToStringEPcj"]
...
extern "C" {
	...
	#[link_name = "\u{1}_ZN21ISteamNetworkingUtils20SetConfigValueStructERK28SteamNetworkingConfigValue_t27ESteamNetworkingConfigScopei"]
